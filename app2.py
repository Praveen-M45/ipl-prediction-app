...
# Initialize session state for toss_winner and team tracking
if 'toss_winner' not in st.session_state:
    st.session_state.toss_winner = None
if 'prev_team1' not in st.session_state:
    st.session_state.prev_team1 = None
if 'prev_team2' not in st.session_state:
    st.session_state.prev_team2 = None
...
def main():
    ...
    with st.form(key="prediction_form"):
        ...
        # Update toss_winner options based on team1 and team2
        toss_winner_options = [team1, team2]
        # Reset toss_winner if team1 or team2 changes
        if team1 != st.session_state.prev_team1 or team2 != st.session_state.prev_team2:
            st.session_state.toss_winner = team1
            st.session_state.prev_team1 = team1
            st.session_state.prev_team2 = team2
